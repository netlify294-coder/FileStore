...
MESSAGES = {
    ...
    "REPLY": "<b>For More Join - @salesgodx</b>",
    ...
    "TRIAL_USED": "<b>⚠️ {first}, आपने अपना फ्री ट्रायल एक बार इस्तेमाल कर लिया है!</b>\n\nदोबारा देखने के लिए प्रीमियम लीजिए और मुझसे जुड़े रहिए 👇"
}
